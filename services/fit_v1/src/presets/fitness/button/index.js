export default {
    root: ({ props, context, parent, instance }) => ({
        class: [
            ...
            // Primary Button
            {
                'text-text-primary': !props.link && props.severity === null && !props.text && !props.outlined && !props.plain,
                'bg-primary': !props.link && props.severity === null && !props.text && !props.outlined && !props.plain,
                'border border-border': !props.link && props.severity === null && !props.text && !props.outlined && !props.plain
            },
            // Primary Text Button
            { 'text-text-primary': props.text && props.severity === null && !props.plain },
            // Primary Outlined Button
            { 'text-text-primary border border-primary': props.outlined && props.severity === null && !props.plain },

            // Secondary Button
            {
                '!text-green dark:text-white': props.severity === 'secondary' && !props.text && !props.outlined && !props.plain,
                '!bg-light-green dark:bg-surface-700': props.severity === 'secondary' && !props.text && !props.outlined && !props.plain,
                '!border !border-solid !border-green dark:border-surface-700': props.severity === 'secondary' && !props.text && !props.outlined && !props.plain
            },
            // Secondary Text Button
            { 'text-surface-500 dark:text-surface-300': props.text && props.severity === 'secondary' && !props.plain },
            // Secondary Outlined Button
            { 'text-green bg-white border border-white dark:text-surface-300 hover:bg-white': props.outlined && props.severity === 'secondary' && !props.plain },
            ...
            // Primary
            { 'hover:bg-primary-emphasis hover:border-green': !props.link && props.severity === null && !props.text && !props.outlined && !props.plain },
            { 'focus:ring-primary': props.severity === null },
            // Text & Outlined Button
            // { 'hover:bg-primary-300/10': (props.text || props.outlined) && props.severity === null && !props.plain },
            { 'hover:bg-middle-green': (props.text || props.outlined) && props.severity === 'primary' && !props.plain },

            // Secondary
            { 'hover:bg-middle-green dark:hover:bg-surface-600 dark:hover:border-surface-600': props.severity === 'secondary' && !props.text && !props.outlined && !props.plain },
            ...
            '[&>[data-pc-name=badge]]:text-sm [&>[data-pc-name=badge]]:absolute [&>[data-pc-name=badge]]:top-5 [&>[data-pc-name=badge]]:right-4'
        ]
    }),
    label: ({ props }) => ({
        class: [
    ...
    icon: ({ props }) => ({
        class: [
            ...
            'mx-0',
            {
                'text-3xl leading-4': props.size === 'large',
