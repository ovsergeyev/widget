export default {
    ...
    box: ({ props, context }) => ({
        class: [
            ...
            // Colors
            {
                'border-solid border-green dark:border-surface-700': !context.checked && !props.invalid,
                'bg-surface-0 dark:bg-surface-950': !context.checked && !props.invalid && !props.disabled,
                'border-solid border-green bg-primary': context.checked
            },
    ...
    input: {
        class: [
            ...
            'rounded',
            'outline-none',
            'border border-green dark:border-surface-700',
    ...
    icon: ({ context, state }) => ({
        class: [
            ...
            // Colors
            {
                'text-green dark:text-surface-950': context.checked,
