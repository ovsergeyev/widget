    ...
    message: ({ props }) => ({
        class: [
            ...
            // Colors
            {
                ...
                'bg-white dark:bg-green-500/20': props.message.severity == 'success',
            ...
            },
            {
                ...
                'border-green dark:border-green-500/20': props.message.severity == 'success',
            ...
            },
            {
                ...
                'text-green dark:text-green-300': props.message.severity == 'success',
