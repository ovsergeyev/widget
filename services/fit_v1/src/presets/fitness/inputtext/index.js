export default {
    root: ({ props, context, parent }) => ({
        class: [
            ...
            'shadow-sm',
            'placeholder:!text-text-secondary dark:placeholder:text-surface-500',
            { 'bg-surface-0 dark:bg-surface-950': !context.disabled },
            '!border !border-solid !border-border',
            { 'border-border dark:border-surface-700': !props.invalid },
            ...
            // States
            {
                'hover:border-green dark:hover:border-surface-600': !context.disabled && !props.invalid,
