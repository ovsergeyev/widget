export default {
    root: ({ props, context, parent, instance }) => ({
        class: [
            ...
            { 'hover:bg-light-green': (props.text || props.outlined) && props.severity === 'primary' && !props.plain },
            ...
            '[&>[data-pc-name=badge]]:text-sm [&>[data-pc-name=badge]]:absolute [&>[data-pc-name=badge]]:top-3 [&>[data-pc-name=badge]]:right-2'
        ]
    }),
    label: ({ props }) => ({
        class: [
